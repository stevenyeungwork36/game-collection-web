// Card display info for Exploding Kittens (rules + played card expand). Mirrors backend kittens-cards.
...
export function getCardInfo(type) {
  return CARD_INFO[type] ? { ...CARD_INFO[type] } : null
}

export const CARD_LIST_FOR_RULES = [
  'exploding_kitten',
  'defuse',
  'skip',
  'attack',
